...
export const ApartmentDesc = () => {
  return (
    <Container className="apartment-description">
      ...
      <Segment>
        <SemanticHeader as='h3'>Location</SemanticHeader>
      ...
      <Segment>
        <SemanticHeader as='h3'>Facilities & Amenities</SemanticHeader>
      ...
      <Segment>
        <SemanticHeader as='h3'>Distances & Travel</SemanticHeader>
        <DistancesList />
      ...
      <Segment>
        <SemanticHeader as='h3'>Prices & Recommendations</SemanticHeader>
        <PricesList />
